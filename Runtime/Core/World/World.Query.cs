...
namespace ZenECS.Core
{
    public sealed partial class World
    {
            ...
            public struct Enumerator
            {
                ...
                public bool MoveNext()
                {
                    while (it.MoveNext())
                    {
                        ...
                        if ((a == null || a.Has(id)) && MeetsFilter(id, rf)) { cur = new Entity(id); return true; }
                    }
                    return false;
                }
            }
        ...
        public struct QueryEnumerable<T1, T2> where T1 : struct where T2 : struct
        {
            private readonly World w; private readonly Filter f;
            internal QueryEnumerable(World w, Filter f) { this.w = w; this.f = f; }
            public Enumerator GetEnumerator() => new(w, f);
        ...
        public struct QueryEnumerable<T1, T2, T3> where T1 : struct where T2 : struct where T3 : struct
        {
            private readonly World w; private readonly Filter f;
            internal QueryEnumerable(World w, Filter f) { this.w = w; this.f = f; }
            public Enumerator GetEnumerator() => new(w, f);
            ...
            where T1 : struct where T2 : struct where T3 : struct where T4 : struct
        {
            ...
            public struct Enumerator
            {
                ...
                public Enumerator(World w, Filter f)
                {
                    ...
                    var seed = Seed(a, b, c, d);
                    it = (seed != null ? seed.EnumerateAll().GetEnumerator() : Empty().GetEnumerator()); cur = default;
                }
                public Entity Current => cur;
                public bool MoveNext()
                {
            ...
            where T5 : struct where T6 : struct where T7 : struct where T8 : struct
        {
            ...
            public struct Enumerator
            {
                ...
                public Enumerator(World w, Filter f)
                {
                    ...
                    var seed = Seed(a, b, c, d, e, f6, g, h);
                    it = (seed != null ? seed.EnumerateAll().GetEnumerator() : Empty().GetEnumerator()); cur = default;
                }
                public Entity Current => cur;
                public bool MoveNext()
